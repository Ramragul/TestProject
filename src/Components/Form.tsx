...
const schema = z.object ({
    name: z.string().min(3 , {message : "Name should be atleast three character"}),
    age:z.number({invalid_type_error : 'Age Field is Required'}).min(18, {message:"Age must be Greater than 18"})
})
